...
public class Robot extends TimedRobot {
  ...
  /**
   * Periodic function called every 20ms in all robot modes. Runs the command
   * scheduler to execute
   * ongoing commands and update subsystems. This method is crucial for continuous
   * robot operation
  ...
  /**
   * Called when autonomous mode is initialized. Retrieves and schedules the
   * selected autonomous
   * command from RobotContainer. If no command is selected, this method will
  ...
  /**
   * Called when operator control is initialized. Cancels any running autonomous
   * command to ensure
   * safe transition to manual control. This prevents autonomous commands from
   * interfering with
   * driver inputs.
   */
  @Override
  ...
  /**
   * Called when test mode is initialized. Cancels all running commands to ensure
   * a clean slate for
   * testing. This helps prevent interference from commands that might have been
   * left running in
   * other modes.
   */
  @Override
